...
public class BlockBulletMaker extends Block {
	public static final ITextComponent TITLE_BULLET_MAKER =
            new TranslationTextComponent("container." + GunCus.MOD_ID + ".bullet_maker");
	...
	public INamedContainerProvider getContainer(BlockState state, World worldIn, BlockPos pos) {
		return new SimpleNamedContainerProvider((windowId, inv, player) ->
                new ContainerBulletMaker(windowId, inv, pos), BlockBulletMaker.TITLE_BULLET_MAKER);
	}
}
