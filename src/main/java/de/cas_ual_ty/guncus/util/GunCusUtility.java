...
public class GunCusUtility {
	...
	public static PointOfInterestType pointOfInterestType(String p1, Set<BlockState> p2,
	                                                      int p3, SoundEvent p4, int p5) {
		try {
			Constructor<PointOfInterestType> c =
					PointOfInterestType.class
							.getDeclaredConstructor(String.class, Set.class,
									Integer.TYPE, SoundEvent.class, Integer.TYPE);
	...
	public static VillagerProfession villagerProfession(String p1, PointOfInterestType p2,
	                                                    ImmutableSet<Item> p3, ImmutableSet<Block> p4) {
		try {
			Constructor<VillagerProfession> c =
					VillagerProfession.class
							.getDeclaredConstructor(String.class, PointOfInterestType.class,
									ImmutableSet.class, ImmutableSet.class);
			c.setAccessible(true);
